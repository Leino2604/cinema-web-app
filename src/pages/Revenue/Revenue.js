...
const Revenue = () => {
  ...
  const fetchRevenues = async (month, year) => {
    ...
    setRevenues(data);
    setMonthRevenueTicket(data.MonthTicketRevenue || 0)
    setMonthRevenueFood(data.MonthFoodRevenue || 0)
    setMonthRevenueTheater(data.MonthTheatersRevenue || 0)
    setMonthRevenueFilms(data.MonthRevenueFilms || 0)
    setMonthRevenueFoods(data.MonthRevenueFoods || 0)
  };
          ...
          <Table style= {{margin: "0 50px", width: "100%"}}>
            <thead>    
                 <tr>
                   ...
                   <th style={{width: "63%"}}>Tên</th>
                   <th style={{width: "7%"}}>Lượng bán ra</th>
